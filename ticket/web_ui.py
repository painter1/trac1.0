...
from trac.ticket.notification import TicketNotifyEmailCustom # PCMDI Customization
#from trac.ticket.notification import TicketNotifyEmail    #original
...
class TicketModule(Component):
    ...
    def _do_create(self, req, ticket):
        ...
        # Notify
        try:
            tn = TicketNotifyEmailCustom(self.env, req) # PCMDI Customization
            #tn = TicketNotifyEmail(self.env) # original

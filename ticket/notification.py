...
# PCMDI Customization.
class TicketNotifyEmailCustom(TicketNotifyEmail):
    """Notification of ticket changes customized for CF."""

    def __init__(self, env, req, log=None ):
        self.smtp_from_name = req.session.get('name', None)
        self.smtp_from_email = req.session.get('email', None)
    ...
    def send(self, torcpts, ccrcpts):
        ...
        hdrs['Reply-To'] = 'no-reply@llnl.gov'
